...
describe('Component Tests', () => {
  describe('TypeCommune Management Component', () => {
    let comp: TypeCommuneComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TypeCommuneComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.typeCommunes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
