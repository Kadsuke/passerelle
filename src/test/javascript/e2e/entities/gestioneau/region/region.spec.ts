...
describe('Region e2e test', () => {
  ...
  it('should load Regions', async () => {
    ...
    expect(await regionComponentsPage.getTitle()).to.eq('passerelleApp.gestioneauRegion.home.title');
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle()).to.eq('passerelleApp.gestioneauRegion.home.createOrEditLabel');
  ...
  it('should create and save Regions', async () => {
    ...
    await promise.all([regionUpdatePage.setLibelleInput('libelle')]);

    expect(await regionUpdatePage.getLibelleInput()).to.eq('libelle', 'Expected Libelle value to be equals to libelle');
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle()).to.eq('passerelleApp.gestioneauRegion.delete.question');
